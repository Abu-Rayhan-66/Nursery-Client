          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <Link to={`/productDetails/${item._id}`}>
                <button disabled={item.quantity === 0} className={`${item.quantity === 0 ? "opacity-50 cursor-not-allowed" : ""} py-1 px-4  text-white rounded-tl-md rounded-br-md bg-[#03AED2] text-lg font-medium`}>View Details</button>
              </Link>
            </div>
          </div>
        </div>
